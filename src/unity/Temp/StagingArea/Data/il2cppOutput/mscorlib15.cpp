...
IL_00ba:
	{
		...
		Type_t * L_36 = VirtFuncInvoker0< Type_t * >::Invoke(17 /* System.Type System.Reflection.FieldInfo::get_FieldType() */, L_35);
...
IL_0101:
	{
		...
		RuntimeFieldHandle_t844BDF00E8E6FE69D9AEAA7657F09018B864F4EF  L_50 = VirtFuncInvoker0< RuntimeFieldHandle_t844BDF00E8E6FE69D9AEAA7657F09018B864F4EF  >::Invoke(16 /* System.RuntimeFieldHandle System.Reflection.FieldInfo::get_FieldHandle() */, L_49);
		V_5 = L_50;
		intptr_t L_51 = (&V_5)->get_value_0();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UnauthorizedAccessException__ctor_mE67AE27F79595BF7594E2D76D24336E64293693E (UnauthorizedAccessException_tC2210A745BFDD3AE3559A87A4219E2945EEC9F75 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		((Exception_t *)__this)->set__HResult_11(((int32_t)-2147024891));
		return;
	}
}
...
IL_00e7:
	...
	}
	{
		...
		int32_t L_34 = L_33->get_m_stringLength_0();
		if (L_34)
		{
			goto IL_0107;
		}
...
IL_011a:
	{
		...
		int32_t L_37 = L_36->get_m_stringLength_0();
		if (L_37)
		{
			goto IL_0135;
		}
...
IL_014e:
	...
	}
	{
		...
		int32_t L_46 = L_45->get_m_stringLength_0();
		if (L_46)
		{
			goto IL_016e;
		}
...
IL_01cb:
	...
	}
	{
		...
		int32_t L_64 = L_63->get_m_stringLength_0();
		if (L_64)
		{
			goto IL_01eb;
		}
...
IL_000e:
	{
		SerializationInfo_t1BB80E9C9DEA52DBF464487234B045E2930ADA26 * L_2 = ___info0;
		bool L_3 = __this->get_isLongReference_0();
...
IL_0048:
	{
		...
		CompareInfo_tB9A071DBC11AC00AF2EA2066D0C2AE1DCB1865D1 * L_10 = VirtFuncInvoker0< CompareInfo_tB9A071DBC11AC00AF2EA2066D0C2AE1DCB1865D1 * >::Invoke(10 /* System.Globalization.CompareInfo System.Globalization.CultureInfo::get_CompareInfo() */, L_9);
...
IL_00cf:
	{
		...
		int32_t L_56 = L_55->get_m_stringLength_0();
...
IL_00f0:
	...
	}
	{
		...
		int32_t L_68 = L_67->get_m_stringLength_0();
	...
	}
	{
		...
		int32_t L_70 = L_69->get_m_stringLength_0();
		int32_t L_71 = V_1;
...
IL_0147:
	...
	}
	{
		...
		int32_t L_90 = L_89->get_m_stringLength_0();
