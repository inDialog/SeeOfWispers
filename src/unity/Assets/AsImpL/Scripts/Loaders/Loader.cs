...
namespace AsImpL
{
    ...
    public abstract class Loader : MonoBehaviour
    {
        ...
        public static Dictionary<string, GameObject> loadedModels = new Dictionary<string, GameObject>();
        ...
        protected IEnumerator Build(string absolutePath, string objName, Transform parentTransform)
        {
            ...
            if (parentTransform != null) newObj.transform.SetParent(parentTransform.transform, true);
            OnCreated(newObj, absolutePath);
        ...
        protected virtual void SetProperties(GameObject obj)
        {
